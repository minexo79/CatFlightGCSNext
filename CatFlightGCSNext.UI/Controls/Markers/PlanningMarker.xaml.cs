...
namespace CatFlightGCSNext.UI.Controls.Markers
{
    ...
    /// </summary>
    public partial class PlanningMarker
    {
        MapControl control;
        GMapMarker marker;
        Popup popup;
        ...
        public PlanningMarker(MapControl _control, GMapMarker _marker, int number)
        {
            InitializeComponent();
            ...
            {
                Background = ColorConvert.ToBrush("#172320"),
            ...
            label.Content = markType.Content = $"{number}";
